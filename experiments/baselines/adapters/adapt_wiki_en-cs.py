...
from adaptor.new_objectives.adapters_seq2seq import AdapterSequence2Sequence
from adaptor.schedules import ParallelSchedule
from adaptor.utils import AdaptationArguments, StoppingStrategy
from utils.data_utils_opus import OPUSDataset, OPUS_RESOURCES_URLS

data_dir = "utils"
experiment_id = "adapters_wiki"
...
train_mle = AdapterSequence2Sequence(lang_module,
...
for dataset_id in test_dataset_ids:
    ...
    new_eval_objective = AdapterSequence2Sequence(lang_module,
                                                  texts_or_path=train_dataset.source,
